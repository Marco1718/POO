...
public class Lang {
    ...
    public String INVALID_INPUT_NEGATIVE_NUMBER;
    public String GOODBYE;
    public String LANGUAGE_MENU_TOP;
    ...
    public String STUDENT_ID_HEADLINER;
    public String STUDENT_AGE;
    public String STUDENT_AGE_HEADLINER;
    public String STUDENT_ENROLLMENT;
    public String STUDENT_ENROLLMENT_HEADLINER;
    ...
    public String COURSE_NAME_HEADLINER;
    public String COURSE_TOPIC_NAME;
    public String COURSE_TOPIC_NAME_HEADLINER;
    public String COURSE_TOPIC_ID;
    public String COURSE_TOPIC_ID_HEADLINER;
    public String COURSE_TOPIC_CREDITS;
    public String COURSE_TOPIC_CREDITS_HEADLINER;
    public String COURSE_TOPIC_HOURS;
    public String COURSE_TOPIC_HOURS_HEADLINER;
    public String COURSE_ADDED;
    ...
    // Mostrar cursos
    public String SHOW_COURSES;
    public String SHOW_COURSES_MENU;
    public String SHOW_COURSES_MENU_NAME;
    public String SHOW_COURSES_MENU_TOPICS;
    public String SHOW_COURSES_MENU_CREDITS;
