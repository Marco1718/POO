package edu.marco.garcia.actividades.proyecto.ui;
...
import edu.marco.garcia.actividades.proyecto.lang.Eng;
import edu.marco.garcia.actividades.proyecto.lang.Esp;
import edu.marco.garcia.actividades.proyecto.lang.Jap;
import edu.marco.garcia.actividades.proyecto.lang.Lang;
...
public class CLI {
    ...
    public static final String NEGRO_CLARO = "\u001B[90m";
    ...
    // Fondos brillantes (alta intensidad)
    public static final String FONDO_NEGRO_CLARO = "\u001B[100m";
    public static final String FONDO_ROJO_CLARO = "\u001B[101m";
    public static final String FONDO_VERDE_CLARO = "\u001B[102m";
    public static final String FONDO_AMARILLO_CLARO = "\u001B[103m";
    ...
    static String usernameLogged;
        ...
        public static void runApp() {
                ...
                while (opcion !=3) {
                    showMenu();
                    while (true) {
                        System.out.print("\u001B[30m" + lang.select_an_option);
                        String input = scanner.nextLine().trim(); 
